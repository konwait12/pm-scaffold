#!/usr/bin/env python3
"""Unit tests for solution-assessment validate_artifact.py — Source Fidelity (SRC-ID / knowledge state)."""

import sys
import tempfile
from pathlib import Path

SKILL_SCRIPT = Path(__file__).resolve().parent.parent.parent.parent / "src/support-skills/solution-assessment/scripts/validate_artifact.py"
...
def test_confirmed_fixture_passes_with_traceability_warning():
    ...
    fixture = Path(__file__).resolve().parent / "fixtures/solution-confirmed.md"
