#!/usr/bin/env python3
"""Unit tests for the independent user-journey validator."""
...
SKILL_SCRIPT = Path(__file__).resolve().parent.parent.parent.parent / "src/stages/001-business-requirements/skills/user-journey/scripts/validate_artifact.py"
