...
SECTION_NAME = "验收依据"          # e.g. "交互规则"（子 Skill 输出父产物章节）
ID_PATTERN = r"\bAC-\d+\b"        # e.g. r"\bIX-\d+\b"
# ─────────────────────────────────────────────────────────

SKILL_ID = "acceptance_criteria"  # issue family（统一错误格式分组）
CHECK_PREFIX = "ac"               # issue check_id 语义化前缀
