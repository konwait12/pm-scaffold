...
SECTION_NAME = "状态变化"          # e.g. "交互规则"（子 Skill 输出父产物章节）
ID_PATTERN = r"STATE-\d+"          # e.g. r"\bIX-\d+\b"
# ─────────────────────────────────────────────────────────

SKILL_ID = "state_machine"        # issue family（统一错误格式分组）
CHECK_PREFIX = "sm"               # issue check_id 语义化前缀
