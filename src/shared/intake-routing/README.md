...
Assess input maturity as L0 vague input, L1 business need, L2 business solution, L3 product solution, or L4 detailed specification. Present the assessment for human confirmation. L0 triggers brainstorming; L1-L4 still enter at the earliest unconfirmed predecessor. Use `src/templates/others/entry-assessment.md` when a persistent routing record is needed.
