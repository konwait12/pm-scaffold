# Audit Checklist · Feasibility Analysis

## Structural Gate

- All required headings exist for the feasibility report (主线: 市场空间 / 技术可行性 / 投入产出 / 风险评估 / 结论; §多方案取舍 章节: 候选方案 / 方案对比矩阵 / AI 推荐 / 人工决策, 仅在 ≥2 实质方案时出现) before the version-change summary.
