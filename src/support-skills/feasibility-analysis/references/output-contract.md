# Output Contract · Feasibility Analysis
...
Use the headings from `src/templates/support/solution-comparison.md` as the chapter structure inside `feasibility-report.md`:
...
The §多方案取舍 chapter is embedded in the single feasibility report — never produced as a separate artifact.
