...
- **21 个同等丰富的 Skill**：5 主 + 8 子 + 8 分支，每个都有标准章节执行协议 + 7 类知识库 + 机器校验器。
...
| 分支（8） | `brainstorming` · `competitive-research` · `solution-assessment` · `prd-publish` · `project-scope` · `requirement-restate` · `tracking-plan` · `issue-record` |
